...
# 文件路径
spec_Path="./MediatorModule.podspec"
...
# git add .
# git commit -m "update to MediatorModule tag:${UpVersion}"
# git tag ${UpVersion}
# git push
# git push --tags
# pod repo push ${SpecName} MediatorModule.podspec --verbose --allow-warnings --use-libraries --use-modular-headers
