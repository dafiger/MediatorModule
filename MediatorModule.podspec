...
s.version      = '0.0.6'
  ...
  s.description  = <<-DESC
                    this is MediatorModule
                   DESC

  s.homepage     = 'https://github.com/dafiger/MediatorModule'
  ...
  s.source       = { :git => 'https://github.com/dafiger/MediatorModule.git', :tag => s.version.to_s }
  ...
  # 资源文件1
  s.resource_bundles = {
    'MediatorModule' => ['MediatorModule/Assets/**/*']
  }
  # s.resource_bundles = { 
  #   'MediatorModuleResourceBundle' => ['MediatorModule/Resource_bundle.xcassets'],
  #   'MediatorModuleOtherResources' => ['MediatorModule/Resource']
  # }
  ...
  # s.resources  = 'MediatorModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}', 'MediatorModule/Assets.xcassets'
  # s.resources  = ['MediatorModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}']
  # s.resources  = 'MediatorModule/**/*.{png,jpg,jpeg,xcassets,bundle,storyboard,xib,json,plist,db}'
  ...
  #     ss.source_files = 'MediatorModule/Classes/ModuleManager/**/*'
  #     ss.public_header_files = 'MediatorModule/Classes/ModuleManager/**/*.h'
